...
- [game.js](file:///home/tomaso/projects/scubeat/game.js): Contains the Core Phaser game logic, custom Web Audio synthesis, and procedural generation algorithms.
- [.agents/ponytail.md](file:///home/tomaso/projects/scubeat/.agents/ponytail.md): Defines the Ponytail Philosophy (lazy senior dev mode, YAGNI, standard APIs, fewest files).
- [index.html](file:///home/tomaso/projects/scubeat/index.html): Defines the user interface, custom track uploader, YouTube audio link resolver, and global CSS visual styles.
- [server.py](file:///home/tomaso/projects/scubeat/server.py): Defines the custom Python development server supporting YouTube audio proxies (`/yt-audio`) and console logging redirection (`/log`).
